...
public class PrimsGraphDrawer extends View {
    ...
    public PrimsGraphDrawer(Context context) {
        super(context);
        initialise();
    }

    public PrimsGraphDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialise();
    }
    ...
    private void drawGraph(Canvas canvas) {
        ...
        int[][] vertices = {
                ...
                {getWidth() - getDimensionInPixel(40),
                        getWidth() - getDimensionInPixel(100),
                        getWidth() - getDimensionInPixel(30),
                        getWidth() / 2 - getDimensionInPixel(55),
                        getDimensionInPixel(100),
                        getDimensionInPixel(40),
                        getWidth() / 2 ,
                        getDimensionInPixel(30),
                        getWidth() / 2 + getDimensionInPixel(10),
                        getWidth() / 2 + getDimensionInPixel(30)
    ...
    private void drawNodes(Canvas canvas) {
        for (Map.Entry<Integer, Point> entry : pointMap.entrySet()) {
            ...
            for (int i : graph.neighbors(key)) {
                drawNodeLine(canvas, key, i, graph.getWeight(key, i));
            }
